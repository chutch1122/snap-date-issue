...
@General(title = "Date Issue - ZonedDateTime",
         purpose = "Demonstrate problem when writing a ZonedDateTime to an output view.",
...
public class ZonedDateTimeSnap implements Snap {
    ...
    public void execute() throws ExecutionException {
        ...
        row.put("dateOfBirth", ZonedDateTime.of(LocalDateTime.of(1990, 12, 25, 1, 30), ZoneId.of("UTC")));
