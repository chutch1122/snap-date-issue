...
@General(title = "Date Issue - LocalDate",
         purpose = "Demonstrate problem when writing a LocalDate to an output view.",
...
public class LocalDateSnap implements Snap {
    ...
    public void execute() throws ExecutionException {
        ...
        row.put("dateOfBirth", LocalDate.of(1990, 12, 25));
