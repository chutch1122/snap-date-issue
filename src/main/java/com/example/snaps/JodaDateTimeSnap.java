...
@General(title = "Date Issue - Joda DateTime",
         purpose = "Demonstrate problem when writing a Joda DateTime to an output view.",
...
public class JodaDateTimeSnap implements Snap {
